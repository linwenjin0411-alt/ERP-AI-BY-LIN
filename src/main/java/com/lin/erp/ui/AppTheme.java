...
public final class AppTheme {
    ...
    public static final Color NAV_SELECTED = new Color(51, 113, 220);
    ...
    public static final Color ACCENT = new Color(52, 105, 206);
    public static final Color ACCENT_DARK = new Color(33, 73, 150);
    public static final Color ACCENT_SOFT = new Color(235, 244, 255);
